...
import tr.edu.gazi.kutuphanem.repository.BookRepository;
import tr.edu.gazi.kutuphanem.service.dto.BookDTO;
import tr.edu.gazi.kutuphanem.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).numOfPage(UPDATED_NUM_OF_PAGE).cover(UPDATED_COVER).coverContentType(UPDATED_COVER_CONTENT_TYPE);
