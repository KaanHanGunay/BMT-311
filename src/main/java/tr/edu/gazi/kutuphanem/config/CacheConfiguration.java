...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tr.edu.gazi.kutuphanem.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tr.edu.gazi.kutuphanem.repository.UserRepository.USERS_BY_EMAIL_CACHE);
