...
import tr.edu.gazi.kutuphanem.service.AuthorQueryService;
import tr.edu.gazi.kutuphanem.service.AuthorService;
...
/**
 * REST controller for managing {@link tr.edu.gazi.kutuphanem.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
     ...
     */
    @GetMapping("/authors")
    public ResponseEntity<List<AuthorDTO>> getAllAuthors(AuthorCriteria criteria) {
        log.debug("REST request to get Authors by criteria: {}", criteria);
        List<AuthorDTO> entityList = authorQueryService.findByCriteria(criteria);
