...
import tr.edu.gazi.kutuphanem.service.PublisherQueryService;
import tr.edu.gazi.kutuphanem.service.PublisherService;
import tr.edu.gazi.kutuphanem.service.criteria.PublisherCriteria;
...
/**
 * REST controller for managing {@link tr.edu.gazi.kutuphanem.domain.Publisher}.
 */
@RestController
@RequestMapping("/api")
public class PublisherResource {
    ...
    public ResponseEntity<List<PublisherDTO>> getAllPublishers(PublisherCriteria criteria) {
        log.debug("REST request to get Publishers by criteria: {}", criteria);
        List<PublisherDTO> entityList = publisherQueryService.findByCriteria(criteria);
