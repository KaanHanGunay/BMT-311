...
/**
 * Criteria class for the {@link tr.edu.gazi.kutuphane.domain.Borrowing} entity. This class is used
 * in {@link tr.edu.gazi.kutuphane.web.rest.BorrowingResource} to receive all the possible filtering options from
