...
import tr.edu.gazi.kutuphane.service.AuthorQueryService;
...
/**
 * REST controller for managing {@link tr.edu.gazi.kutuphane.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
     ...
     */
    @GetMapping("/authors")
    public ResponseEntity<List<Author>> getAllAuthors(AuthorCriteria criteria) {
        log.debug("REST request to get Authors by criteria: {}", criteria);
        List<Author> entityList = authorQueryService.findByCriteria(criteria);
