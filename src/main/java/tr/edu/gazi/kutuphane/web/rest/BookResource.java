...
import tr.edu.gazi.kutuphane.service.BookQueryService;
...
/**
 * REST controller for managing {@link tr.edu.gazi.kutuphane.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
    ...
    public ResponseEntity<List<Book>> searchBooks(@RequestBody BookSearch params) {
        return ResponseEntity.ok().body(bookService.searchBook(params));
    }
}
